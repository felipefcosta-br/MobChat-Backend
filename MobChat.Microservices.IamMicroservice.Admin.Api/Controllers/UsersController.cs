...
using MobChat.Microservices.IamMicroservice.Admin.Api.Configuration.Constants;
using MobChat.Microservices.IamMicroservice.Admin.Api.Dtos.Roles;
using MobChat.Microservices.IamMicroservice.Admin.Api.Dtos.Users;
using MobChat.Microservices.IamMicroservice.Admin.Api.ExceptionHandling;
using MobChat.Microservices.IamMicroservice.Admin.Api.Helpers.Localization;
using MobChat.Microservices.IamMicroservice.Admin.Api.Resources;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Services.Interfaces;

namespace MobChat.Microservices.IamMicroservice.Admin.Api.Controllers
{
        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        //-------------------------------------
        // Cria um usuário com o role de AppUser
        // AppUser role id = e6070e80-0932-4e4f-bcf9-bab4c542426d
        [HttpPost("AppUsers")]
        [ProducesResponseType(201)]
        [ProducesResponseType(400)]
        public async Task<ActionResult<TUserDto>> PostAppUser([FromBody] UserPasswordDto userPasswordDto)
        {
            ...
            //UserRoleApiDto<TKey> role
            var role = await _identityService.GetRoleAsync("e6070e80-0932-4e4f-bcf9-bab4c542426d");
            var userRoleApiDto = new UserRoleApiDto<TKey>();
            userRoleApiDto.UserId = createdUser.Id;
            userRoleApiDto.RoleId = role.Id;

            var userRolesDto = _mapper.Map<TUserRolesDto>(userRoleApiDto);
