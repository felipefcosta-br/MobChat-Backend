...
using MobChat.Microservices.IamMicroservice.STS.Identity.ViewModels.Manage;

namespace MobChat.Microservices.IamMicroservice.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MobChat.Microservices.IamMicroservice.STS.Identity"),
