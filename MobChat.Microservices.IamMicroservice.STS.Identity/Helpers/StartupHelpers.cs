...
using SendGrid;
using MobChat.Microservices.IamMicroservice.Shared.Configuration.Email;
using MobChat.Microservices.IamMicroservice.Shared.Email;
using MobChat.Microservices.IamMicroservice.STS.Identity.Configuration;
using MobChat.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
using MobChat.Microservices.IamMicroservice.STS.Identity.Configuration.Constants;
using MobChat.Microservices.IamMicroservice.STS.Identity.Configuration.Interfaces;
using MobChat.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace MobChat.Microservices.IamMicroservice.STS.Identity.Helpers
{
