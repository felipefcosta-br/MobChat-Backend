...
using MobChat.Microservices.IamMicroservice.Admin.ExceptionHandling;
using MobChat.Microservices.IamMicroservice.Admin.Configuration;
using MobChat.Microservices.IamMicroservice.Admin.Configuration.ApplicationParts;
using MobChat.Microservices.IamMicroservice.Admin.Configuration.Constants;
using MobChat.Microservices.IamMicroservice.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using MobChat.Microservices.IamMicroservice.Admin.Helpers.Localization;
using System.Linq;
using MobChat.Microservices.IamMicroservice.Admin.EntityFramework.MySql.Extensions;
using MobChat.Microservices.IamMicroservice.Admin.EntityFramework.Shared.Configuration;
using MobChat.Microservices.IamMicroservice.Admin.EntityFramework.SqlServer.Extensions;
using MobChat.Microservices.IamMicroservice.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using MobChat.Microservices.IamMicroservice.Shared.Authentication;
using MobChat.Microservices.IamMicroservice.Shared.Configuration.Identity;

namespace MobChat.Microservices.IamMicroservice.Admin.Helpers
{
